...
function VideoCard({ displayVideo,setDeleteVideoStatus }) {
  ...
  const dragStarted = (e,id)=>{
    ...
    // e.dataTransfer.setData("videiId",id)
      ...
      <Card style={{ width: '100%', height: "350px" }} className='mt-5 mb-5' draggable onDragStart={(e)=>dragStarted(e,displayVideo.id)}>
       ...
       video caption
          ...
          <div className='d-flex  align-items-center justify-content-evenly'>
            <h6 className='' >{displayVideo.caption}</h6>
            <Button variant="danger" className='ms-3' onClick={()=>removeVideo(displayVideo.id)} > <i class="fa-solid fa-trash"></i></Button>
